...
public class MetricResults extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metric_results);
        ...
        btnSubjectSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(etSubject1.getText().toString().trim().isEmpty() || etSubject2.getText().toString().trim().isEmpty() ||etSubject3.getText().toString().trim().isEmpty() ||
                    ...
                    Toast.makeText(MetricResults.this, "Enter All The Seven Subject Marks", Toast.LENGTH_SHORT).show();
                }
                else{
                    showProgress(true);
                    ...
                    Backendless.Persistence.save(mark, new AsyncCallback<MetricMarks>() {
                        ...
                        public void handleResponse(MetricMarks response) {
                            showProgress(false);
                            Toast.makeText(MetricResults.this, "Marks Successfully Saved..", Toast.LENGTH_SHORT).show();
                            Toast.makeText(MetricResults.this, "Successfully Registered..", Toast.LENGTH_SHORT).show();
                            MetricResults.this.finish();

                        }

                        @Override
                        public void handleFault(BackendlessFault fault) {
                            Toast.makeText(MetricResults.this, "ERROR : "+ fault.getMessage(), Toast.LENGTH_SHORT).show();
                            showProgress(false);
